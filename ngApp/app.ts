namespace MyApp {
    ...
    angular.module('MyApp', ['ngRoute', 'ngResource', 'ngMaterial', 'ngMessages', 'ngAnimate']).config(($routeProvider: ng.route.IRouteProvider, $locationProvider: ng.ILocationProvider) => {
        $routeProvider
            .when('/', {
            ...
            .when('/search', {
                templateUrl: '/ngApp/views/carSearch.html',
                controller: MyApp.Controllers.CarSearchController,
                controllerAs: 'vm'
            })
            .when('/list', {
                templateUrl: '/ngApp/views/carsList',
